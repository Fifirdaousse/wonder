...
class QuestionController extends AbstractController
{
    ...
    public function show(Request $request, QuestionRepository $questionRepo, int $id, Question $question, EntityManagerInterface $em): Response
    {
    ...
    public function ratingQuestion(Request $request, Question $question, int $score, EntityManagerInterface $em, VoteRepository $voteRepo)
    {
        ...
        $this->addFlash('error', 'Vous ne pouvez pas voter votre question');
